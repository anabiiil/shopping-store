...
return [
    ...
    */
    ...
    | permissions relationships with the possible admin models, and the
    ...
    */
    'panel' => [
        ...
        */
        ...
        |
        */
        'assign_permissions_to_admin' => true,
        ...
        */
        'roles_restrictions' => [
            // The admin won't be able to remove roles already assigned to admins.
            'not_removable' => [],

            // The admin won't be able to edit the role and the permissions assigned.
            'not_editable' => [],

            // The admin won't be able to delete the role.
            'not_deletable' => [],
        ],
    ]
];
