...
<body>
	<table width='700px'>
		<tr><td>&nbsp;</td></tr>
		<tr><td><img src="{{ asset('front/images/home/logo.png') }}"></td></tr>
		<tr><td>&nbsp;</td></tr>
		...
		<tr><td>
			<table width='95%' cellpadding="5" cellspacing="5" bgcolor="#f7f4f4">
				...
				<tr>
					<td colspan="5" align="right">Coupon Discount</td><td>${{ $productDetails['coupone_amount'] }}</td>
				</tr>
				<tr>
		...
		<tr><td>&nbsp;</td></tr>
		<tr><td>For any enquiries, you can contact us at <a href="mailto:mustafa.salama2608@gmail.com">mustafa.salama2608@gmail.com</a></td></tr>
		<tr><td>&nbsp;</td></tr>
		<tr><td>Regards,<br> Mustafa Salama</td></tr>
		<tr><td>&nbsp;</td></tr>
	</table>
</body>
</html>
